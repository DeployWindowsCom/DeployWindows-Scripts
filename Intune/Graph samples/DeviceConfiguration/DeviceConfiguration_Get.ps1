...
**Full credit to previous authors of the source script
**Reference: https://github.com/microsoftgraph/powershell-intune-samples/blob/master/DeviceConfiguration/DeviceConfiguration_Get.ps1

.AUTHOR Mattias Alvbring @ Deploywindows 

.RELEASENOTES
Updated version of Microsoft sample script of DeviceConfiguration_Get.ps1 with support for decryption of encrypted policies, windows10CustomConfiguration
